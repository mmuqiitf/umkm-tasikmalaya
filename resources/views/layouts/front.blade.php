        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    <!-- Mobile menu button-->
                    <button type="button" x-on:click.prevent="isMobileNavOpen = !isMobileNavOpen"
            ...
            -->
                        <svg :class="{ 'hidden' : isMobileNavOpen, 'block': !(isMobileNavOpen) }" class="block h-6 w-6"
            ...
            -->
                        <svg :class="{ 'block' : isMobileNavOpen, 'hidden': !(isMobileNavOpen) }" class="hidden h-6 w-6"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

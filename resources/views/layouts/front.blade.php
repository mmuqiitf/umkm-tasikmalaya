        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <div class="font-medium text-base text-gray-800">Mohamad Muqiit Faturrahman</div>
                        <div class="font-medium text-sm text-gray-500">mmuqiit.f14@gmail.com</div>
                    </div>
                        ...
                        <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                                ...
                                <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                                    ...
                                    <a href="#" class="font-medium text-gray-500 hover:text-gray-900">GIS</a>
                    ...
                    <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                <span class="block xl:inline">WEBGIS PEMETAAN DAN PENDATAAN</span>
                                <span class="block text-indigo-600 xl:inline">UMKM Tasikmalaya</span>
                            </h1>
                            <p
                                class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Website ini berfungsi sebagai pemetaan dan pendataan dari semua Usaha Mikro Keci dan
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div class="px-4 py-5 sm:px-6">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                Silakan cari UMKM dari maps berikut
                            </p>
                        </div>
                        <div>

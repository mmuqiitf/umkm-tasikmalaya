        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl pb-3">Ubah Kecamatan</h1>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('name')
                                                <x-input type="text" name="name" id="name" class="mt-1"
                                                    :isValid="false" value="{{ old('name') ?? $user->name }}">
                                                </x-input>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('username')
                                                <x-input type="text" name="username" id="username" class="mt-1"
                                                    :isValid="false" value="{{ old('username') ?? $user->username }}">
                                                </x-input>
                                                <span class="text-sm text-red-700">{{ $message }}</span>
                                            @else
                                                <x-input type="text" name="username" id="username" class="mt-1"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('nik')
                                                <x-input type="text" name="nik" id="nik" class="mt-1"
                                                    :isValid="false" value="{{ old('nik') ?? $user->nik }}">
                                                </x-input>
                                                <span class="text-sm text-red-700">{{ $message }}</span>
                                            @else
                                                <x-input type="text" name="nik" id="nik" class="mt-1"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('email')
                                                <x-input type="email" name="email" id="email" class="mt-1"
                                                    :isValid="false" value="{{ old('email') ?? $user->email }}">
                                                </x-input>
                                                <span class="text-sm text-red-700">{{ $message }}</span>
                                            @else
                                                <x-input type="email" name="email" id="email" class="mt-1"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('address')
                                                <x-input type="text" name="address" id="address" class="mt-1"
                                                    :isValid="false" value="{{ old('address') ?? $user->address }}">
                                                </x-input>
                                                <span class="text-sm text-red-700">{{ $message }}</span>
                                            @else
                                                <x-input type="text" name="address" id="address" class="mt-1"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            @error('phone')
                                                <x-input type="text" name="phone" id="phone" class="mt-1"
                                                    :isValid="false" value="{{ old('phone') ?? $user->phone }}">
                                                </x-input>
                                                <span class="text-sm text-red-700">{{ $message }}</span>
                                            @else
                                                <x-input type="text" name="phone" id="phone" class="mt-1"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <x-input input="select" id="role" name="role">
                                                ...
                                                <option value="umkm" @if ($user->role === 'umkm') selected @endif>User</option>
                                            </x-input>
                                        </div>
                                    </div>
